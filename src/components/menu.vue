  ...
  <div class="home" :class="this.$store.getters.getState + ' ' + isClosed">
    <section class="rk_sct1 rk_pleine_hauteur rk_sct1_menu">
      <h1 :class="{
        ...
        <span @mouseleave="currentSection = 0" @click="isClosed = 'closed'" @mouseenter="timeout(3)">
    ...
    <div @click="isClosed = 'opened';" class="rk_small_menu">
      <div></div>
      <div></div>
      <div></div>
    </div>
...
export default {
  ...
  async mounted() {
    ...
    setTimeout(() => {
      ...
      currentApp.$store.commit('appState', 'loaded');
    }, 200);
  },
...
.home {
  ...
  &.closed {
    ...
    .rk_sct1 {
      transition: all 0s 1.6s !important;
      height: 0px;
      overflow: hidden;
    }
